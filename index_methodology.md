...
opment of the blockchain or to correct certain parts of the transcation history. The old
blockchain’s transaction history is therefore often kept intact or partly intact in order to retains as much of the old network as possible. This
results in that those who held cryptocurrency on the old blockchain find themselves to hold an euqal amount of cryptocurrency on the new blockchain. However, due to new struc-
tural and technological aspects of each blockchain the combined value of these assets do not need to equal the value of the assets held before the fork.
